  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Không thể tải dữ liệu người dùng. Vui lòng thử lại!'),
        ),
      );
    } finally {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        systemOverlayStyle:
            SystemUiOverlayStyle.light, // Đặt màu thanh trạng thái
      ),
      body:
          _isLoading
              ? Center(
                        ...
                        children: [
                          ...
                          Stack(
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Material(
                                  color:
                                      Colors.teal.shade700, // Màu teal đậm hơn
                                  shape: CircleBorder(),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 8),
                              Flexible(
                                // Sử dụng Flexible để tránh tràn chữ
                                child: Text(
                                  user?.email ??
                                      _userData['email'] ??
                                      'Email chưa cập nhật',
                          ...
                          children: [
                            ...
                            _buildInfoCard(
                              ...
                              showBadge:
                                  _userData['name'] == null ||
                                  _userData['name']
                                      .isEmpty, // Hiện badge nếu thông tin chưa đầy đủ
                            ),
                            ...
                            _buildInfoCard(
                              ...
                              subtitle:
                                  'Xem lại lịch sử chỉ số sức khỏe của bạn',
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                            ...
                            _buildInfoCard(
                              ...
                              subtitle:
                                  'Theo dõi và nhắc nhở uống nước hàng ngày',
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                            ...
                            _buildInfoItem(
                              ...
                              title: 'Ngày sinh',
                              value: _formatDate(
                                _userData['dateOfBirth'] as Timestamp?,
                              ),
                            ),
                            Divider(height: 1, color: Colors.grey.shade200),
                            _buildInfoItem(
                              icon:
                                  _userData['gender'] == 'Nam'
                                      ? Icons.male
                                      : (_userData['gender'] == 'Nữ'
                                          ? Icons.female
                                          : Icons.wc), // Icon giới tính
                              title: 'Giới tính',
                            ...
                            _buildSettingItem(
                              ...
                              subtitle:
                                  'Thay đổi mật khẩu, quản lý phiên đăng nhập',
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Tính năng bảo mật đang phát triển',
                                    ),
                                  ),
                                );
                            ...
                            _buildSettingItem(
                              ...
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Tính năng thông báo đang phát triển',
                                    ),
                                  ),
                                );
                            ...
                            _buildSettingItem(
                              ...
                              subtitle:
                                  'Tìm hiểu về cách chúng tôi bảo vệ dữ liệu của bạn',
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Tính năng chính sách bảo mật đang phát triển',
                                    ),
                                  ),
                                );
                            ...
                            _buildSettingItem(
                              ...
                              onTap: logOut,
                              iconColor:
                                  Colors.redAccent, // Đổi màu icon đăng xuất
                              textColor:
                                  Colors.redAccent, // Đổi màu chữ đăng xuất
                            ),
