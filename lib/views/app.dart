...
import 'package:my_wellness/views/screens/chart/chart.dart';
import 'package:my_wellness/views/screens/account_setting/account_setting.dart';
...
class MainApp extends State<MyApp> {
  ...
  @override
  static List<Widget> _option = <Widget>[HomePage(), Chart(), AccountSetting()];
