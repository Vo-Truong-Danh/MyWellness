...
import 'package:my_wellness/src/data/models/daily_log.dart';
...
class _ChartState extends State<Chart> with SingleTickerProviderStateMixin {
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        final date = _demoWeightData[value.toInt()]['date'] as DateTime;
                        return Padding(
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: List.generate(_demoWeightData.length, (index) {
                      return FlSpot(index.toDouble(), _demoWeightData[index]['value']);
                    }),
                    isCurved: true,
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        final date = _demoCaloriesData[value.toInt()]['date'] as DateTime;
                        return Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text(
                            DateFormat('dd/MM').format(date),
  ...
  Widget _buildHeartRateChart() {
    ...
    final heartRateData = [
      {'date': DateTime.now().subtract(Duration(days: 6)), 'avg': 72, 'max': 110},
      {'date': DateTime.now().subtract(Duration(days: 5)), 'avg': 75, 'max': 125},
      {'date': DateTime.now().subtract(Duration(days: 4)), 'avg': 71, 'max': 118},
      {'date': DateTime.now().subtract(Duration(days: 3)), 'avg': 74, 'max': 130},
      {'date': DateTime.now().subtract(Duration(days: 2)), 'avg': 73, 'max': 122},
      {'date': DateTime.now().subtract(Duration(days: 1)), 'avg': 76, 'max': 135},
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        final date = heartRateData[value.toInt()]['date'] as DateTime;
                        return Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text(
                            DateFormat('dd/MM').format(date),
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        final date = progressData[value.toInt()]['date'] as DateTime;
                        return Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text(
                            DateFormat('dd/MM').format(date),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildSummaryItem('Cao nhất', '${_getMaxValue(data).toStringAsFixed(1)} kg'),
              _buildSummaryItem('Thấp nhất', '${_getMinValue(data).toStringAsFixed(1)} kg'),
              _buildSummaryItem('Trung bình', '${_getAvgValue(data).toStringAsFixed(1)} kg'),
            ],
          ),
        ],
      ),
