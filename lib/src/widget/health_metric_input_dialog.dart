...
class HealthMetricInputDialog extends StatefulWidget {
  ...
  static Future<bool?> show(
    ...
    return await showDialog<bool>(
      context: context,
      builder: (context) => HealthMetricInputDialog(
        title: title,
  ...
  @override
  _HealthMetricInputDialogState createState() => _HealthMetricInputDialogState();
}
...
class _HealthMetricInputDialogState extends State<HealthMetricInputDialog> {
  ...
  Future<void> _handleSave() async {
    ...
    for (var field in widget.inputFields) {
      if (field.required && (_values[field.name] == null || _values[field.name].toString().isEmpty)) {
        isValid = false;
      ...
      case InputFieldType.number:
        return Padding(
          ...
          child: TextField(
            ...
            keyboardType: TextInputType.numberWithOptions(decimal: field.allowDecimal),
